...
class Relation(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        PASSWORD = '#PWD_INSTAGRAM_BROWSER:0:' + str_time + ':' + '#nayana31094'
   ...
   ##########################################################
    ...
    def parse_follower(self, response):
        ...
        if follower_num > 1000:
            ...
            ###################################################
            df_over1000.to_csv(r'C:\Users\sojeo\SJ_practice\Crawling Practice\Instagram Scrapy again\cc_over1000.csv')
            ###################################################
            return
        # follower_lst 추출
        follower_lst = follower_json['data']['user']['edge_followed_by']['edges']
